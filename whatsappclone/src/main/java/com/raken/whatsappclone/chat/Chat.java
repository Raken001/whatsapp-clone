package com.raken.whatsappclone.chat;


import com.raken.whatsappclone.common.BaseAuditingEntity;
import com.raken.whatsappclone.message.Message;
import com.raken.whatsappclone.message.MessageState;
import com.raken.whatsappclone.message.MessageType;
import com.raken.whatsappclone.user.User;
...
public class Chat extends BaseAuditingEntity {
    ...
    public LocalDateTime getLastMessageTime() {
        if (messages != null && !messages.isEmpty()) {
            return messages.get(0).getCreatedDate();  // messages are ordered in descending order so get 0
        }
        return null;
    }
}
